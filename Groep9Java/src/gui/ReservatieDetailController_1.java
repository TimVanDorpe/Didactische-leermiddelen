...
public class ReservatieDetailController_1 extends Pane {
    ...
    public ReservatieDetailController_1(ReservatieController rc, ProductController pc, boolean isWijziging) {
        // TODO

        this.isWijziging = isWijziging;

        FXMLLoader loader = new FXMLLoader(getClass().getResource("ReservatieDetail_1.fxml"));
        this.rc = rc;
        this.pc = pc;
        loader.setRoot(this);
